...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    @if($favorites->count() === 0)
        <div class="otl-surface py-16 px-6 text-center">
            ...
            <p class="text-[#7e8488] mb-6">Вы ещё не добавили отели в избранное.<br>Найдите подходящий вариант в каталоге.</p>
            <a href="{{ route('hotels.index') }}" class="btn-accent px-6 py-3">За вдохновением</a>
        </div>
    @else
