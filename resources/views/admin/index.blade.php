...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-700">
            <h3 class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">Всего бронирований</h3>
            <p class="text-3xl font-bold text-[#38b000]">{{ $stats['total_bookings'] }}</p>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-700">
            <h3 class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">Общий доход</h3>
            <p class="text-3xl font-bold text-[#38b000]">{{ number_format($stats['total_revenue'], 0) }} ₸</p>
        </div>
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-700">
            <h3 class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">Ожидающие отзывы</h3>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-700">
            <h3 class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">Всего пользователей</h3>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <a href="{{ route('admin.hotels.index') }}" class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition text-center">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400">Создание, редактирование, удаление</p>
        </a>
        ...
        <a href="{{ route('admin.bookings.index') }}" class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition text-center">
            <h3 class="font-semibold mb-2">Управление бронированиями</h3>
            <p class="text-sm text-gray-600 dark:text-gray-400">Просмотр и управление</p>
        </a>
        <a href="{{ route('admin.users.index') }}" class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition text-center">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400">Блокировка/Разблокировка</p>
        </a>
        <a href="{{ route('admin.reviews.index') }}" class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition text-center">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400">Одобрение/Отклонение</p>
        </a>
    </div>
</div>
@endsection
