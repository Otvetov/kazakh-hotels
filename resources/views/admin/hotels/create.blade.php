...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <form action="{{ route('admin.hotels.store') }}" method="POST" enctype="multipart/form-data" class="bg-whitebg-gray-800 rounded-lg shadow-md p-6 border border-gray-200border-gray-700">
        @csrf
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea name="address" required rows="3"
                          class="w-full px-4 py-2 border border-gray-300border-gray-600 rounded-lg bg-whitebg-gray-700">{{ old('address') }}</textarea>
            </div>

            <div>
                <label class="block text-sm font-medium mb-2">Description</label>
                <textarea name="description" rows="5"
                          class="w-full px-4 py-2 border border-gray-300border-gray-600 rounded-lg bg-whitebg-gray-700">{{ old('description') }}</textarea>
            </div>
