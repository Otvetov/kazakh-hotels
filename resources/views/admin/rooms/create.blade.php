...
@section('title', __('messages.admin_add_room') . ' - Kazakh Hotels')

@section('content')
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <h1 class="text-2xl font-extrabold text-white mb-6">{{ __('messages.admin_add_room') }}</h1>
        ...
        <div class="space-y-5">
            <div>
                ...
                <select name="hotel_id" required class="field-input" style="color-scheme: dark;">
                    <option value="">{{ __('messages.admin_choose_hotel') }}</option>
            ...
            <div class="flex gap-3">
                <button type="submit" class="btn-accent flex-1 py-3">{{ __('messages.admin_create_room') }}</button>
